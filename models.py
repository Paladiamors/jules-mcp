...
class SourceContext(BaseModel):
    ...
    source: str = Field(..., description="Resource name of the source (e.g., sources/github/owner/repo)")
...
class Session(BaseModel):
    ...
    url: Optional[str] = Field(None, description="URL to view the session in Jules web app")
